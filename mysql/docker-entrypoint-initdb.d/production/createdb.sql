...
-- Step 1: Create new user for the new DBs
-- CREATE USER 'newuser'@'localhost' IDENTIFIED BY 'password';

-- Or update its password to prevent external attacks
-- ALTER USER 'default'@'%' IDENTIFIED BY 'New-Password-Here';

-- Step 2: Amend the GRANT ALL ON use to the new user created
...
-- Step 3: Update all you project DB credentials with the new user and password
